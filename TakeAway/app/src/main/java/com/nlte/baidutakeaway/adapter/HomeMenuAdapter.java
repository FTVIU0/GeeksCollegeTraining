 ...
 */
public class HomeMenuAdapter extends RecyclerView.Adapter<HomeMenuAdapter.CardViewHolder> {

    private List<UserCard> mUserCards;

    public HomeMenuAdapter(List<UserCard> userCards) {
    ...
    public CardViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.home_menu, parent, false);
